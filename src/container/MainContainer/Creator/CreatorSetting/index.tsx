...
import {CreatorSettingsData} from '@utils/data';
...
const CreatorSetting = ({navigation}: any) => {
  ...
  const renderItem = ({item}: any) => {
    return (
      <TouchableOpacity
        ...
        {/* Show right arrow for navigation items (except logout) */}
      </TouchableOpacity>
    );
  };

  const flatData = !CreatorSettingsData
    ? []
    : CreatorSettingsData?.reduce<any>((acc, section) => {
        if (section.section) {
