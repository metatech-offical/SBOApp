...
import {ChooseYourPlanProps} from '@navigation/screens';
...
const ChooseYourPlan: React.FC<ChooseYourPlanProps> = ({navigation, route}) => {
  ...
  const renderPlanItem = ({item, index}: {item: string; index: number}) => {
    ...
    return (
      <View style={styles.itemContainer}>
        ...
        {planData?.plans?.map((plan, i) => {
          const isDisabled = false; // Made all plans selectable
        ...
        <ScrollView bounces={false} showsVerticalScrollIndicator={false}>
          <View style={[styles.subViewStyle, {marginTop: top}]}>
            ...
            <Text style={styles.subTitleStyle}>
              Experience exclusive live streams, stunning 8K VR content, earn
              from your videos and explore so much more.
            </Text>
          ...
          <View style={styles.mainContainer}>
            <LinearGradient
              ...
              <FlatList
                ...
                scrollEnabled={false}
                style={{zIndex: 2}}
                contentContainerStyle={{paddingBottom: 45, paddingTop: 10}}
              />
            </LinearGradient>
          ...
          <View style={[styles.subViewStyle]}>
            <CustomButton
              ...
              textStyle={[
                styles.buttonText,
                {color: Colors.black, opacity: buttonColors.opacity},
              ]}
              btnStyle={[
                styles.btnStyle,
                {
            ...
            <Text style={styles.descriptionStyle}>
              By tapping submit, you will be charged, your subscription will
              auto renew for the same price and package length until you cancel
              via App store settings, and you agree to our{' '}
...
const styles = StyleSheet.create({
  ...
  headerItem: {
    alignItems: 'center',
    justifyContent: 'flex-start',
    width: '22%', // Equal width for plan columns
  ...
  // Permanent plan colors
  creatorPlan: {
    backgroundColor: '#6C6382',
    paddingTop: 15,
  },
  // Permanent feature item colors
  creatorFeatureItem: {
    backgroundColor: '#6C6382',
    borderWidth: 1,
    borderColor: '#6C6382',
  ...
  itemText: {
    width: '50%', // Increased width to match header
    color: Colors.white,
    fontSize: fontSize.f12,
    fontFamily: fonts['Poppins-Regular'],
    lineHeight: 16,
  ...
  itemValueContainer: {
    width: '22%', // Equal width for value columns
    alignItems: 'center',
    justifyContent: 'center',
